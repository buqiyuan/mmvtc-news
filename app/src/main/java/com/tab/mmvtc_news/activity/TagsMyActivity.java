...
public class TagsMyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tags_item_my);
        initView();
    }
    ...
    private void initView() {
        ...
        tagsGender = (ImageView) findViewById(R.id.tags_gender);
        peoplePor = (ImageView) findViewById(R.id.people_por);
        age = (TextView) findViewById(R.id.tags_age);
        edu = (TextView) findViewById(R.id.tags_edu);
        likeBuy = (TextView) findViewById(R.id.tv_like_buy);
        likeMoive = (TextView) findViewById(R.id.tv_like_moive);
        likeGame = (TextView) findViewById(R.id.tv_like_game);
    ...
    private void readData() {
        ...
        try {
            ...
            //Log.e("TagsMyActivity ", " " + e.getMessage());
        }


        String usertags = (String) serializableHashMap.getMap().get("userTags");
        Log.e("SDK+", "TagsMyActivity 个人信息页面，得到的数据 ===》 " + usertags);
        ...
        try {
            ...
            Log.e("TagsMyActivity", " server is not response " + t.getMessage());
        }
       /* try {
            tags_id.clear();
