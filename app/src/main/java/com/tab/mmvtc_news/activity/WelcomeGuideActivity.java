...
import com.tab.mmvtc_news.adapter.GuideViewPagerAdapter;
...
//加载视频资源控件
        //设置播放加载路径
        videoview.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.guide_last));
        //播放
        videoview.start();
        //循环播放
        videoview.setOnCompletionListener(mediaPlayer -> mediaPlayer.start());
        //设置s声音大小
        videoview.setOnPreparedListener(mediaPlayer -> mediaPlayer.setVolume(0.1f, 0.1f));
    }
